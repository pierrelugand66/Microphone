...
class Ui_DialogConnexion(object):
    ...
    def retranslateUi(self, DialogConnexion):
        ...
        self.radio_local.setText(QCoreApplication.translate("DialogConnexion", u"Mode Local  \u2014  r\u00e9seau Wi-Fi partag\u00e9 (LAN)", None))
        self.radio_distant.setText(QCoreApplication.translate("DialogConnexion", u"Mode Distant  \u2014  port forwarding (r\u00e9seau externe)", None))
        ...
        self.label_ip_info.setText(QCoreApplication.translate("DialogConnexion", u"Le routeur doit rediriger les ports UDP 5001 et 5002 vers la carte.", None))
